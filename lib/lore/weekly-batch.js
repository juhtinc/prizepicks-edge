...
WORD COUNT:
- ABSOLUTE HARD LIMIT: 110 words MAXIMUM. ElevenLabs speaks at ~1.9 words/second with natural pauses. 110 words ≈ 58 seconds. Count EVERY word. Aim for 100-110.
...
- HOOK (0-3s): The first sentence decides if the viewer swipes. Use a shocking stat, impossible claim, or mystery that DEMANDS an answer. This is the most important sentence in the entire script.
- ESCALATION (3-15s): Each sentence must raise the stakes. The viewer should think "wait, it gets CRAZIER?"
- TURN (15-30s): Introduce the unexpected twist — the part of the story nobody knows. This is where you earn the full watch.
- PAYOFF (30-50s): Deliver on the promise of the hook. Connect the dots. Make the viewer feel smart for staying.
- KICKER (50-60s): End with a question that makes the viewer want to comment AND rewatch. The question must recontextualize the opening.
