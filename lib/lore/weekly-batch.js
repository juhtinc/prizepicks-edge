...
Select 7 unique story ideas. This is Batch ${batchHalf} of 2 weekly batches (14 videos total per week, 2 per day). Each story should be about a different NBA player/event. ALL stories must be NBA-focused.

FOCUS: Legacy/classic NBA players — think pre-2000s and early 2000s era. Players whose stories deserve to be retold. Avoid current active players and avoid GOAT comparison debates (no "X vs Y" matchups).
${avoidList}
...
- forgotten_legend, trending_callback, what_if, rivalry, record_breaker, comeback, scandal, draft_bust, underdog

DO NOT use goat_debate. Weight toward forgotten_legend, what_if, and scandal — stories that make people say "I had no idea." Mix provocation levels — include at least 2 "hot take" story types (rivalry, scandal, draft_bust) for engagement.
