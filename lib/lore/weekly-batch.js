...
module.exports = async function handler(req, res) {
  ...
  if (phase === "plan") {
    ...
    const storyPrompt = `You are the content strategist for ColdVault, a YouTube Shorts channel about forgotten and surprising sports history.
...
FOCUS: Mix of classic AND modern NBA players. Stories that make people say "wait, WHAT?" and "I had no idea." Avoid currently active players. No GOAT comparison debates (no "X vs Y" matchups).

ERA MIX (aim for this split out of 7 videos):
- 4 classic era (1980s-2000s): Forgotten legends, record breakers, scandals from the golden age
- 3 modern era (2005-2020): Derrick Rose, Jeremy Lin, Brandon Roy, Gilbert Arenas, Lamar Odom, Andrew Bynum — stories the YouTube Shorts audience (18-34) grew up with and will instantly engage with
This mix gives the channel both nostalgia depth AND relatability for younger viewers.

CRITICAL — FOOTAGE REQUIREMENT: Only select players who played from 1980 onwards. We need real game footage available on YouTube for the video. Players from the 1950s-1970s (like Bob Pettit, Connie Hawkins, George Mikan, etc.) do NOT have enough video footage. The exception is mega-stars from the 1960s-70s with documented footage (Wilt Chamberlain, Kareem Abdul-Jabbar, Bill Russell, Dr. J). When in doubt, pick a player from 1985+.
