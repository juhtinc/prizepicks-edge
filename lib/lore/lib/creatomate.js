...
async function renderVideo({ voiceoverUrl, musicTrackUrl, clipUrls, textOverlays }) {
  ...
  modifications["Background Footage"] = { source: (clipUrls && clipUrls[0]) || DEFAULT_FOOTAGE };
  modifications["Voiceover"] = { source: voiceoverUrl || "" };
  modifications["Background Music"] = musicTrackUrl ? { source: musicTrackUrl } : { source: "" };
