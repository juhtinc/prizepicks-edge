...
module.exports = async function handler(req, res) {
  ...
  for (const script of toCheck) {
    ...
    typePerf = typePerf ? (typeof typePerf === 'string' ? JSON.parse(typePerf) : typePerf) : { totalViews: 0, totalRetention: 0, count: 0, underperformers: 0 };
    ...
    typePerf.avgRetention = (typePerf.totalRetention / typePerf.count).toFixed(1);
    typePerf.failRate = ((typePerf.underperformers / typePerf.count) * 100).toFixed(0);
